...
<div class="relative w-full h-[320px]" id="home">
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
        <div class="w-full px-6">
            <h1 class="text-gray-700 font-medium text-4xl md:text-5xl leading-tight mb-2">Ethereal Beauty</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div class="max-w-lg">
                ...
                <p class="mt-4 text-gray-600 text-lg">
                    At Ethereal Beauty, we’re passionate about creating high-quality products that empower you to express
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-700 text-base">At Ethereal Beauty, we craft brands that celebrate confidence and
                        individuality.
                        From clean skincare and bold cosmetics to nourishing haircare, our products are designed to meet
                        diverse beauty
                        needs. Discover innovation, inclusivity, and self-expression with every Ethereal brand.</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-700 text-base">At Ethereal Beauty, we ensure your favorite products reach you
                        quickly and
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-700 text-base">At Ethereal Beauty, our passionate team blends creativity and
