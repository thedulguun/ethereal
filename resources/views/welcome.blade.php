...
@section('content')
  ...
  <section id="Projects"
    ...
    <div class="w-72 bg-white shadow-md rounded-xl transition-transform duration-500 hover:scale-105 hover:shadow-xl">
      <a href="{{ url('/product1')}}">
        <img src="/upload/{{$value->image_url}}" alt="Product" class="h-80 w-72 object-cover rounded-t-xl" />
        <div class="p-4">
  ...
  <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
    ...
    <div class="space-y-2 text-sm">
      ...
      <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email"
        class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">jinnionbeauty@gmail.com</a>
      </div>
      <div class="flex">
