...
<nav class="flex flex-wrap items-center justify-between p-3 bg-[#e8e8e5]">
    <div class="text-xl">Jinnion</div>
    <div class="flex md:hidden">
        <button id="hamburger">
          <img class="" src="" width="40" height="40" />
          <img class="" src="" width="40" height="40" />
        </button>
    </div>
...
<div class="relative w-full h-[320px]" id="home">
    <div class="absolute inset-0 opacity-70">
        <img src="" alt="Background Image" class="object-cover object-center w-full h-full" />

    </div>
    <div class="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
        <div class="md:w-1/2 mb-4 md:mb-0">
            <h1 class="text-grey-700 font-medium text-4xl md:text-5xl leading-tight mb-2">Jinnion beauty</h1>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="/images/jn_logo.jpg" alt="wheat flour grinding"
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="/images/background1.jpg" alt="Coffee"
                    class="w-full h-64 object-cover">
                <div class="p-6 text-center">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img src="/images/background2.jpg" alt="Coffee"
                    class="w-full h-64 object-cover">
                <div class="p-6 text-center">
